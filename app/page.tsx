          ...
          <div className='flex flex-col lg:w-[40%] gap-8 items-center md:items-center lg:items-start'>
            <div className='flex flex-col w-fit'>
              <div className='flex flex-col text-center md:text-center lg:text-left'>
                <h2 className='text-5xl sm:text-6xl md:text-7xl lg:text-8xl xl:text-9xl font-bold text-gray-800 leading-tight underline decoration-gray-800 underline-offset-4'>
                  OUR
                </h2>
                <h2 className='text-5xl sm:text-6xl md:text-7xl lg:text-8xl xl:text-9xl font-bold text-gray-800 leading-tight underline decoration-gray-800 underline-offset-4'>
                  CORE
