        ...
        <div className="flex flex-col min-h-screen w-full gap-4 sm:gap-5 md:gap-7">
            ...
            <div className="flex flex-col items-start w-full px-4 sm:px-6 md:px-8">
                <span className="font-bold w-full break-words">
                    We belong to the World Korean Presbyterian Church denomination and adhere to the Westminster Confession of Faith and its 12 creeds, which are as follows:
                </span>
            </div>
            <div className="flex flex-col items-start w-full px-4 sm:px-6 md:px-8">
                <ol type="1" className="font-normal w-full list-decimal list-outside pl-6 sm:pl-8 md:pl-10 break-words">
                    {CREEDS.map((creed: TheologyCreed, index: number) => <li className="mb-2 break-words" key={index}>{creed}</li>)}
                </ol>
            </div>
        </div>
    )
